...
public class ActuacionController {
    ...
    public ResponseEntity<ActuacionDTO> postActuacion(@RequestBody Actuacion actuacion) {
        ActuacionDTO actuacionDTO = actuacionService.insertarActuacion(actuacion);
